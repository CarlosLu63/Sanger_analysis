...
class Sanger_analysis(object):
    ...
    def main_flow(self, Chr, Pos, version):
        ...
        ###screen ab1 file###
        try:
            input_file = glob.glob(self.sample_path + "*.ab1")
        ...
        for f in input_file:
            ...
            vcf_path, input_filename, output_filename = self.read_ab1(f)
            print("Processing ", input_filename, "\nProgress: ", n, "/", len(input_file))
    ...
    def __init__(self):
        ...
        self.sample_path = "/home/carloslu/Sanger/Sample_file/WES_cases/"
